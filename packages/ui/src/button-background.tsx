...
export function ButtonBackground(props: ButtonBackgroundProps): JSX.Element {
  ...
  const combinedBackgroundStyles = `
    ...
    ${variant === "dark" ? BUTTON_BACKGROUND_CLASS_NAME.VARIANT.DARK : ""}
  ...
  if (!(variant === "accent" || variant === "dark" || variant === "primary" || variant === "secondary")) return <></>
...
export const BUTTON_BACKGROUND_CLASS_NAME = {
  ...
  VARIANT: {
    ...
    DARK: styles.button_background__variant_dark,
